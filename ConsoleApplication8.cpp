...
struct Code //структура, которая хранит длину кода из битов и сам код. назовем ее Код
{
	int Length; //длина кода в битах
	char CodeItself[32]; //сам код
};
int GetLengthInBytes(int BitCount) //возвращает количество байт, требуемое для хранения данного числа бит
{
